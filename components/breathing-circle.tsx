...
import { DynamicShapes } from "@/components/dynamic-shapes"
...
export function BreathingCircle({ isActive, phase, phaseTime, phaseDuration, colorClass }: BreathingCircleProps) {
  const getScale = () => {
